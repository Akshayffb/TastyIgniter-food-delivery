        ...
        <div class="input-group">
            <div class="control-selectlist flex-grow-1">
                <select
                    ...
                    data-request="<?php echo e($this->getEventHandler('onChooseFile')); ?>"
                    data-progress-indicator="<?php echo app('translator')->get('admin::lang.text_loading'); ?>"
                    data-placeholder-text="<?php echo e(sprintf(lang($this->placeholder), strtolower($selectedTypeLabel))); ?>"
...
<?php /**PATH C:\Users\Akshay ffb\Desktop\Freelance\restaurant/app/main/formwidgets/templateeditor/toolbar.blade.php ENDPATH**/ ?>