---
title: 'Order Salad Food Online made easy'
layout: default
permalink: /
description: ''
'[featuredItems]':
            ...
            <div class="row gy-30">
                <div class="col-xl-6">
                    <div class="offer-card mega-hover" data-bg-src="themes/demo/assets/img/bg/fresh-salad.jpg">
                        ...
                        @if ($viewMenuItem)
                        <a href="{{ $viewMenuItem->url }}" class="th-btn">
    ...
    <section class="bg-smoke2 space" id="shop-sec">
        ...
        <div class="container text-center">
            ...
            <div class="row gy-4 filter-active">
                ...
                @if(has_component('featuredItems'))
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat5 cat2">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="themes/demo/assets/img/product/product_1_2.jpg" alt="Product Image">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat1 cat4">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="themes/demo/assets/img/product/product_1_3.jpg" alt="Product Image">
                            <span class="product-tag">Hot</span>
                            <div class="actions">
                                <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat2 cat5">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="themes/demo/assets/img/product/product_1_4.jpg" alt="Product Image">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat3 cat1">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="themes/demo/assets/img/product/product_1_5.jpg" alt="Product Image">
                            <span class="product-tag">New</span>
                            <div class="actions">
                                <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat5 cat4 cat1 cat2">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="themes/demo/assets/img/product/product_1_6.jpg" alt="Product Image">
                            <span class="product-tag">Hot</span>
                            <div class="actions">
                                <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat2 cat1 cat4 cat5">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="themes/demo/assets/img/product/product_1_7.jpg" alt="Product Image">
                            <span class="product-tag">New</span>
                            <div class="actions">
                                <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat3">
                    <div class="th-product product-grid">
                        <div class="product-img">
                            <img src="themes/demo/assets/img/product/product_1_8.jpg" alt="Product Image">
                            <span class="product-tag">Hot</span>
                            <div class="actions">
                                <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                    ...
                    <div class="row">
                        <div class="col-xl-7">
                            <div class="choose-feature-wrap">
                                ...
                                <div class="choose-feature">
                                    <div class="box-icon">
                                        <img src="themes/demo/assets/img/icon/choose_feature_2.svg" alt="Icon">
                                    </div>
                                ...
                                <div class="choose-feature">
                                    <div class="box-icon">
                                        <img src="themes/demo/assets/img/icon/choose_feature_3.svg" alt="Icon">
                                    </div>
                                ...
                                <div class="choose-feature">
                                    <div class="box-icon">
                                        <img src="themes/demo/assets/img/icon/choose_feature_4.svg" alt="Icon">
                                    </div>
        ...
        <div class="container">
            <div class="counter-card-wrap">
                <div class="counter-card">
                    <div class="box-icon">
                        <img src="themes/demo/assets/img/icon/counter_card_1.svg" alt="Icon">
                    </div>
                ...
                <div class="counter-card">
                    <div class="box-icon">
                        <img src="themes/demo/assets/img/icon/counter_card_2.svg" alt="Icon">
                    </div>
                    <div class="media-body">
                ...
                <div class="counter-card">
                    <div class="box-icon">
                        <img src="themes/demo/assets/img/icon/counter_card_3.svg" alt="Icon">
                    </div>
                    <div class="media-body">
                ...
                <div class="counter-card">
                    <div class="box-icon">
                        <img src="themes/demo/assets/img/icon/counter_card_4.svg" alt="Icon">
                    </div>
                    <div class="media-body">
            ...
            <div class="row gy-40 justify-content-center">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="th-product product-deal">
                        <div class="product-img">
                            <img src="themes/demo/assets/img/product/deal_card_1.jpg" alt="Product Image">
                            <div class="actions">
                                <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                                <a href="wishlist.html" class="icon-btn"><i class="far fa-heart"></i></a>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="th-product product-deal">
                        <div class="product-img">
                            <img src="themes/demo/assets/img/product/deal_card_2.jpg" alt="Product Image">
                            <div class="actions">
                                <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                                <a href="wishlist.html" class="icon-btn"><i class="far fa-heart"></i></a>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="th-product product-deal">
                        <div class="product-img">
                            <img src="themes/demo/assets/img/product/deal_card_3.jpg" alt="Product Image">
                            <div class="actions">
                                <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                                <a href="wishlist.html" class="icon-btn"><i class="far fa-heart"></i></a>
            ...
            <div class="row gy-40 justify-content-center">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="th-team team-card">
                        <div class="img-wrap">
                            <div class="shape" data-mask-src="themes/demo/assets/img/bg/team_card_bg.png"></div>
                            <div class="team-img">
                                <img src="themes/demo/assets/img/team/team_1_1.jpg" alt="Team">
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="th-team team-card">
                        <div class="img-wrap">
                            <div class="shape" data-mask-src="themes/demo/assets/img/bg/team_card_bg.png"></div>
                            <div class="team-img">
                                <img src="themes/demo/assets/img/team/team_1_2.jpg" alt="Team">
                            </div>
                        </div>
                        <div class="box-content">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="th-team team-card">
                        <div class="img-wrap">
                            <div class="shape" data-mask-src="themes/demo/assets/img/bg/team_card_bg.png"></div>
                            <div class="team-img">
                                <img src="themes/demo/assets/img/team/team_1_3.jpg" alt="Team">
                            </div>
                        </div>
                        <div class="box-content">
                            <span class="team-desig">Senior Farmers</span>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testi-card">
                                    <p class="testi-card_text">“Our organic farming practices work in harmony with
                                        nature. By avoiding synthetic chemicals, we help protect beneficial insects,
                                        birds, and other wildlife that are vital to a balanced ecosystem.
                                        Organic foods often have a richer”</p>
                                    <div class="testi-card_profile">
                                        <div class="testi-card_avater">
                                            <img src="themes/demo/assets/img/testimonial/testi_1_1.jpg" alt="Avater">
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testi-card">
                                    <p class="testi-card_text">“Fresh Food farming practices work in harmony with
                                        nature. By avoiding synthetic chemicals, we help protect beneficial insects,
                                        birds, and other wildlife that are vital to a balanced ecosystem.
                                        Organic foods help to be fit.”</p>
                                    <div class="testi-card_profile">
                                        <div class="testi-card_avater">
                                            <img src="themes/demo/assets/img/testimonial/testi_1_2.jpg" alt="Avater">
                                        </div>
                                        <div class="testi-card_content">
                ...
                <div class="swiper th-slider has-shadow" id="blogSlider1"
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-img">
                                    <img src="themes/demo/assets/img/blog/blog_1_1.jpg" alt="blog image">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-img">
                                    <img src="themes/demo/assets/img/blog/blog_1_2.jpg" alt="blog image">
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
                                        <a href="blog.html"><i class="far fa-user"></i>By Frutin</a>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-img">
                                    <img src="themes/demo/assets/img/blog/blog_1_3.jpg" alt="blog image">
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
                                        <a href="blog.html"><i class="far fa-user"></i>By Frutin</a>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-img">
                                    <img src="themes/demo/assets/img/blog/blog_1_4.jpg" alt="blog image">
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
                                        <a href="blog.html"><i class="far fa-user"></i>By Frutin</a>
